                    ...
                    <li onclick="location.href='cart.php?prod_id=1'">
						...
						<div class="slide_section">
							...
							<div class="pro_wishlist">
								<?php 
									$result = mysqli_query($con, "SELECT * FROM wishlist WHERE prod_id='$prod_id' AND cat_name='' AND username=''")
								?>
								<a href="cart.php">&#9825; <span style="font-size: 14px;">Add to Wishlist</span></a>
							</div>
						</div>
                    </li>
					-->
									...
									<li onclick="location.href='cart.php?prod_id=<?php echo $prod_id; ?>&amp;prod_name=product_mobile'">
										...
										<div class="slide_section">
											...
											<div class="pro_wishlist">
												<?php 
													if(isset($_SESSION['username'])) {
														$result = mysqli_query($con, "SELECT * FROM wishlist WHERE prod_id='$prod_id' AND cat_name='product_mobile' AND username='$username'");
														if(mysqli_num_rows($result) == 0) {
															?>
																<a href="wishlist.php?prod_id=<?php echo $prod_id; ?>&amp;prod_name=product_mobile">&#9825; <span style="font-size: 14px;">Add to Wishlist</span></a>
															<?php
														} else {
															?>
									...
									<li onclick="location.href='cart.php?prod_id=<?php echo $prod_id; ?>&amp;prod_name=product_electronics'">
										...
										<div class="slide_section">
											...
											<div class="pro_wishlist">
												<?php 
													if(isset($_SESSION['username'])) {
														$result = mysqli_query($con, "SELECT * FROM wishlist WHERE prod_id='$prod_id' AND cat_name='product_electronics' AND username='$username'");
														if(mysqli_num_rows($result) == 0) {
															?>
																<a href="wishlist.php?prod_id=<?php echo $prod_id; ?>&amp;prod_name=product_electronics">&#9825; <span style="font-size: 14px;">Add to Wishlist</span></a>
															<?php
														} else {
															?>
																<a style="color: #ff6554;">&hearts; <span style="font-size: 14px;">In your wishlist</span></a>
									...
									<li onclick="location.href='cart.php?prod_id=<?php echo $prod_id; ?>&amp;prod_name=product_home'">
										...
										<div class="slide_section">
											...
											<div class="pro_wishlist">
												<?php 
													if(isset($_SESSION['username'])) {
														$result = mysqli_query($con, "SELECT * FROM wishlist WHERE prod_id='$prod_id' AND cat_name='product_home' AND username='$username'");
														if(mysqli_num_rows($result) == 0) {
															?>
																<a href="wishlist.php?prod_id=<?php echo $prod_id; ?>&amp;prod_name=product_home">&#9825; <span style="font-size: 14px;">Add to Wishlist</span></a>
															<?php
														} else {
															?>
																<a style="color: #ff6554;">&hearts; <span style="font-size: 14px;">In your wishlist</span></a>
									...
									<li onclick="location.href='cart.php?prod_id=<?php echo $prod_id; ?>&amp;prod_name=product_men'">
										...
										<div class="slide_section">
											...
											<div class="pro_wishlist">
												<?php 
													if(isset($_SESSION['username'])) {
														$result = mysqli_query($con, "SELECT * FROM wishlist WHERE prod_id='$prod_id' AND cat_name='product_men' AND username='$username'");
														if(mysqli_num_rows($result) == 0) {
															?>
																<a href="wishlist.php?prod_id=<?php echo $prod_id; ?>&amp;prod_name=product_men">&#9825; <span style="font-size: 14px;">Add to Wishlist</span></a>
															<?php
														} else {
															?>
																<a style="color: #ff6554;">&hearts; <span style="font-size: 14px;">In your wishlist</span></a>
									...
									<li onclick="location.href='cart.php?prod_id=<?php echo $prod_id; ?>&amp;prod_name=product_women'">
										...
										<div class="slide_section">
											...
											<div class="pro_wishlist">
												<?php 
													if(isset($_SESSION['username'])) {
														$result = mysqli_query($con, "SELECT * FROM wishlist WHERE prod_id='$prod_id' AND cat_name='product_women' AND username='$username'");
														if(mysqli_num_rows($result) == 0) {
															?>
																<a href="wishlist.php?prod_id=<?php echo $prod_id; ?>&amp;prod_name=product_women">&#9825; <span style="font-size: 14px;">Add to Wishlist</span></a>
															<?php
														} else {
															?>
																<a style="color: #ff6554;">&hearts; <span style="font-size: 14px;">In your wishlist</span></a>
